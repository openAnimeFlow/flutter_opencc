...
@ffi.DefaultAsset('package:flutter_opencc_plus/src/lib_opencc.dart')
library;
...
@ffi.Native<opencc_t Function(ffi.Pointer<ffi.Char>)>()
external opencc_t opencc_open(ffi.Pointer<ffi.Char> configFileName);
...
/// opencc. On error the return value will be (opencc_t) -1.
/// @ingroup opencc_c_api
@ffi.Native<opencc_t Function(ffi.Pointer<ffi.WChar>)>()
external opencc_t opencc_open_w(ffi.Pointer<ffi.WChar> configFileName);
...
/// @ingroup opencc_c_api
@ffi.Native<ffi.Int Function(opencc_t)>()
external int opencc_close(opencc_t opencc);
...
/// @ingroup opencc_c_api
@ffi.Native<
  ffi.Pointer<ffi.Char> Function(opencc_t, ffi.Pointer<ffi.Char>, ffi.Size)
>()
...
external void opencc_convert_utf8_free(ffi.Pointer<ffi.Char> str);
